...
export default function Index(props) {
    ...
    useEffect(() => {
        if (preValue !== undefined) {
            router.get(
                route('custom-form.form-records.index', field),
                { q: search },
                {
                    replace: true,
                    preserveState: true,
    ...
    return (
        <AuthenticatedLayout
            ...
            breadcumbs={[
                { name: 'Formulario personalizado', href: route('custom-form.forms.index') },
                {
                    name: `Formulario - ${field.name}`,
                    href: route('custom-form.form-records.index', field),
                },
            ]}
        >
            <Head title={`Registros - ${field.name}`} />
